...
export type PerformanceScopeFiltersProps = {
  ...
  /** Display-only: uppercase the group plant option labels in the list. */
  uppercaseGroupPlantLabels?: boolean
  ...
  /** Vendor group (contracts.group_name / SAP vendor group). Rendered between Product and Supplier. */
...
export function PerformanceScopeFilters({
  ...
  onGroupsChange,
  groupLabel = 'Group',
  groupPlaceholder = 'Select group(s)',
  groupEmptyMessage = 'No groups',
        ...
        <div className={`${gridClass} [&>*]:min-w-0`}>
          ...
          {showGroupPlant && (
            <SearchableMultiSelect
              ...
              uppercaseOptionLabels={uppercaseGroupPlantLabels}
              pinSelectedToTop
            />
          )}
