...
-- Ensure new columns exist on already-created databases
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS cpo_prod_est_month DECIMAL(15,2);
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS pk_prod_est_month DECIMAL(15,2);
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS pome_prod_est_month DECIMAL(15,2);
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS shell_prod_est_month DECIMAL(15,2);
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS cpo_prod_est_year DECIMAL(15,2);
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS pk_prod_est_year DECIMAL(15,2);
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS pome_prod_est_year DECIMAL(15,2);
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS shell_prod_est_year DECIMAL(15,2);
